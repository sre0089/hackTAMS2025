...
<div id="home" className="h-screen bg-[url('../backgrounds/intro_cropcopy.jpg')] bg-no-repeat bg-center bg-cover">
<NavbarPage/>
...
<h2 className='text-4xl text-center text-c3 md:text-5xl text-[#556b2f] font-black'>01.25 - 01.26</h2>
...
<div id='about' className="py-12 bg-cover bg-[url('../backgrounds/aboutBgcopy.jpg')] bg-[length:100%_100%]">
<h1 className='text-c3 text-[80px] text-center text-[#556b2f] font-bold'>about</h1>
{/*about info*/}
...
{/*event boxes*/}
<h1 className='text-c3 text-[80px] text-[#556b2f] text-center font-bold'>events</h1>
<h2 className='text-c3 text-[30px] text-[#556b2f] text-center'>join us for community, networking opportunities, and fun!</h2>
...
<div id='tracks_challenges' className="bg-[url('../backgrounds/BOBBY_DA_GOAT_905x759.png')] sm:bg-[url('../backgrounds/Z_Shorter_TC.PNG')] lg:bg-[url('../backgrounds/BOBBY_DA_GOAT_905x759.png')] bg-no-repeat bg-center bg-cover"> {/*xl:bg-[length:120%_120%] lg:bg-[url('../backgrounds/Z_Short_traincabin_cropped.PNG')]*/}
...
<h2 className='text-[#556b2f] font-bold text-6xl text-center pt-8 pb-4'>partners</h2>
...
<a href={REGISTRATION_LINK} target='_blank' rel='noreferrer' className='text-[#7fa046] hover:text-white'>registration link</a>
</div>
{/*donate*/}
</div>
...
<a href='mailto:team@hacktams.org' className='text-[#7fa046] hover:text-white'>team@hacktams.org</a>
</div>
{/*instagram*/}
<div>
<h3 className='text-c9 font-bold'>instagram</h3>
<a href={INSTAGRAM_LINK} className='text-[#7fa046] hover:text-white' target='_blank' rel='noreferrer'>https://www.instagram.com/hacktams/</a>
</div>
{/*discord*/}
<div>
